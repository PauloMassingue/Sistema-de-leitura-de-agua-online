...
<body>
    ...
    while ($row = $res->fetch_object()) {
        if ($id_leiturista == $row->id) {
            $nome_leiturista = $row->nome;
            break;
        }
    }
    ?>
    ...
    <div class="content" id="content">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <span class="navbar-brand mb-0 h1">Olá, <?php echo htmlspecialchars($nome_leiturista); ?></span>
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active" aria-current="page" href="leiturista.php">Home</a>
                        <a class="nav-link" href="?page=leituraPendente">Leituras pendentes</a>
                ...
                <div class="mt-5">
                    ...
                    switch (@$_REQUEST['page']) {
                        ...
                        case 'historico':
                            ...
                            break;
                        case 'leituraPendente':
                           include("./leituraPendente.php");
                            break;
                        case 'login':
                            include('../index.php');
                            break;
