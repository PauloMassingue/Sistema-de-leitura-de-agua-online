...
switch($_REQUEST['acao']){
        ...
        $linha=$res->fetch_object();
         if($linha->estate==1){
            ...
            if($res==true){
                 ...
                 print"<script>location.href='?page=leiturista';</script>";
            }else{
    ...
    case "editar":
        ...
        $email=$_POST['email'];
              ...
              $res=$conn->query($sql);
              if($res==true){
                   print"<script> alert('Leiturista actualizado com sucesso...');</script>";
                   print"<script>location.href='?page=leiturista';</script>";
              }else{
                  print"<script> alert('Erro ao actualizar Leiturista...');</script>";
                  print"<script>location.href='?page=leiturista';</script>"; 
              }
} 
